...
define config.name = "Doki Doki Murder Case! [v2.4.1] For Mac & Linux"
define config.save_directory = "DDMC_v200"
...
default persistent.ddmm_achievement = True
...
init python:
    if ddmm_online:
        config.name = "Doki Doki Murder Case! [v2.4.1] For Mac & Linux (using DDMM)"
    else:
        config.name = "Doki Doki Murder Case! [v2.4.1] For Mac & Linux"
