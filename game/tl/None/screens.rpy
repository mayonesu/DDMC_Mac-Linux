                ...
                hbox:
                    ...
                    if not persistent.monikabirth and not persistent.newyear:
                        vbox:
                            style_prefix "check"
                            label _("Language")
                            textbutton _("English") action [Language(None), SetVariable("player", ""), Show(screen="change_name", message="Please change your name", ok_action=[SetPersistent("change_language", True), Function(FinishChangeName)])]
                            $ languages = renpy.known_languages()
                            for language in languages:
                                textbutton _(language) action [Language(language), SetVariable("player", ""), Show(screen="change_name", message="Please change your name", ok_action=[SetPersistent("change_language", True), Function(FinishChangeName)])]
                    vbox:
                        style_prefix "check"
                        label _("Auto")
                    ...
                    vbox:
                        style_prefix "check"
                        label _("Save name")
                        textbutton _("ON") action SetPersistent("save_name", True)
                    ...
                    if datetime.date.today().year == 2019 and datetime.date.today().month == 9 and datetime.date.today().day == 22 and _preferences.language != None:
                        vbox:
                            style_prefix "check"
                            label _("Monika")
