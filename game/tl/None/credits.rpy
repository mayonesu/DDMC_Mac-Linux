...
translate None label:
    ...
    label credits2:
        ...
        if persistent.normal_end == 1:
            if _preferences.language == None:
                show expression "bg/poem_normalE.jpg" with Dissolve(1)
            else:
                show expression "tl/Japanese/bg/poem_normalJ.jpg" with Dissolve(1)
        elif persistent.normal_end == 2:
            stop music fadeout 1.0
            show expression "bg/poem_null.jpg"
            with Dissolve(1)
        else:
        ...
        label postcredits_loop:
            ...
            if persistent.normal_end == 1:
                if _preferences.language == None:
                    show expression "bg/poem_normalE.jpg"
                else:
                    show expression "tl/Japanese/bg/poem_normalJ.jpg"
            elif persistent.normal_end == 2:
                show expression "bg/poem_null.jpg"
            else:
                show poem_end
