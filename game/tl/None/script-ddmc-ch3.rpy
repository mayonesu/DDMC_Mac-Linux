...
translate None strings:
    ...
    old "{#ch3_1_main_83e6198b}"
    new "You're the first one here."

    old "{#ch3_1_main_cbd0885b}"
    ...
    old "{#ch3_1_main_22f1452d}"
    new "Of course I do."

    old "{#ch3_1_main_a43490e7}"
    ...
    old "{#ch3_1_main_61ca7335}"
    new "Don't worry."

    old "{#ch3_1_main_8a0a254a}"
    ...
    old "{#ch3_1_main_dbb90297}"
    new "Hey,do you want to check out the pamphlets?"

    old "{#ch3_1_main_3dd8757c}"
    ...
    old "{#ch3_1_main_15f0c011}"
    new "Ah......"

    old "{#ch3_1_main_6aa1d6f8}"
    new "Well,alright!"

    old "{#ch3_1_main_1b66fd80}"
    new "Try not to take too long,okay?"

    old "{#ch3_1_main_80ea11e1}"
    new "I quickly leave the classroom."

    old "{#ch3_1_main_08b7a135}"
