...
label sayori_mad2:
    if renpy.macintosh:
        python:
            import os
            os.system("osascript -e \'display notification \"サ………ヨリ……ヲ……ケ…………セ………\" with title \""+player+"\" sound name \""+config.gamedir+"/tl/None/sfx/trytone.ogg\"\'")
    elif renpy.linux:
        ...
        python:
            ...
            import os
            os.system("notify-send -i "+config.basedir+"/window_icon.png "+player+" \"サ………ヨリ……ヲ……ケ…………セ………\"")
